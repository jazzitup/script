...
inputdir=/store/caf/user/kimy/minbiasHFSkim_run150476All_reHLT_spikeCleanedIsland_v001/    # with /

frontpath='"$inputdir'

echo Now processing !!!!
rfdir /castor/cern.ch/cms$inputdir | grep root >& list
cp list list2

awk -v p='"'$inputdir '{print p$9"\","}' list > tmp.txt
file=list 
curdir=$(pwd)
