...
# with command line options: Configuration/GenProduction/Pyquen_UnquenchedDiJet_Pt50_cfi.py -n 1 -s GEN:hiSignal,SIM,DIGI,L1,DIGI2RAW,HLT:HIon --conditions FrontierConditions_GlobalTag,MC_38Y_V12::All --scenario HeavyIons --himix --geometry Extended --datatier GEN-SIM-RAW --eventcontent=FEVTDEBUGHLT --filein=background.root --fileout=out.root --processName HISIGNAL --customise Configuration/GenProduction/customiseCaloDigisNZS.py --cust_function customiseCaloNZS --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/UserCode/EYKim/script/production/embedding/Pyquen_DiJetUQ_Pt50_cfi_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.py,v $')
)
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('background.root'),
