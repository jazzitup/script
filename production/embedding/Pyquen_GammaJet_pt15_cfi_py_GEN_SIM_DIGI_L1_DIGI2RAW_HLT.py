...
# with command line options: Configuration/GenProduction/Pyquen_GammaJet_pt30_cfi.py -n 1 -s GEN:hiSignal,SIM,DIGI,L1,DIGI2RAW,HLT:HIon --conditions auto:mc --scenario HeavyIons --himix --datatier GEN-SIM-RAW --eventcontent=FEVTDEBUGHLT --filein=___inf___ --fileout=___outf___ --processName HISIGNAL --customise Configuration/GenProduction/customiseCaloDigisNZS.py   --cust_function customiseCaloNZS --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/UserCode/EYKim/script/production/embedding/Pyquen_GammaJet_pt15_cfi_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.py,v $')
)
