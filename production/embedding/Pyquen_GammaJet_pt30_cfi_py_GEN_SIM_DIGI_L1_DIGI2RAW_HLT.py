...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/UserCode/EYKim/script/production/embedding/Pyquen_GammaJet_pt30_cfi_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.py,v $')
)
